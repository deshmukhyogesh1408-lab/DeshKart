    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md mx-auto">
        ...
        <div className="space-y-3">
          <button className="w-full h-12 border border-border rounded-xl text-sm font-medium flex items-center justify-center gap-3 hover:bg-muted transition-colors">
        ...
        <div className="mt-6 p-4 bg-muted/50 rounded-xl border border-border">
          ...
          <div className="space-y-1 text-xs text-muted-foreground">
            <p>
              Customer: <code className="bg-muted px-1 rounded">john@example.com</code> /{" "}
